...
public class GApp extends Application {
    ...
    public static DisplayImageOptions imageLoaderOptions = new DisplayImageOptions.Builder()//
            .showImageOnLoading(R.drawable.picker_ic_default_image)         //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.drawable.picker_ic_default_image)       //设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.drawable.picker_ic_default_image)            //设置图片加载/解码过程中错误时候显示的图片
    ...
    public static ImageOptions xUtilsOptions = new ImageOptions.Builder()//
            ...
            .setLoadingDrawableId(R.drawable.picker_ic_default_image)       //下载中显示的图片
            .setFailureDrawableId(R.drawable.picker_ic_default_image)       //下载失败显示的图片

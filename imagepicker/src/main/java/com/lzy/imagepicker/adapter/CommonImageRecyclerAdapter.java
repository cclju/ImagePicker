...
public class CommonImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
     ...
     * 构造方法
     */
    public CommonImageRecyclerAdapter(Activity activity, ArrayList<ImageItem> images) {

...
import com.lzy.imagepicker.adapter.CommonImageRecyclerAdapterWithHead2;
...
public class StickyDecoration extends RecyclerView.ItemDecoration {
    ...
    private CommonImageRecyclerAdapterWithHead2 mAdapter;
    private final SparseArray<Rect> mHeaderRects = new SparseArray<>();
    private final LongSparseArray<View> mHeaderViews = new LongSparseArray<>();

    public StickyDecoration(CommonImageRecyclerAdapterWithHead2 mAdapter) {
        super();
...
//                final int left = 0;
    ...
    public View getHeader(RecyclerView parent, int position) {
        ...
        if (header == null) {
            //创建HeaderViewHolder
            CommonImageRecyclerAdapterWithHead2.HeaderHolder holder = mAdapter.onCreateHeaderViewHolder(parent);
